...
type MsgSendToCosmosClaim struct {
	...
	Amount         github_com_cosmos_cosmos_sdk_types.IntProto `protobuf:"bytes,4,opt,name=amount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"amount"`
...
type MsgValsetUpdatedClaim struct {
	...
	RewardAmount   github_com_cosmos_cosmos_sdk_types.IntProto `protobuf:"bytes,5,opt,name=reward_amount,json=rewardAmount,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"reward_amount"`
